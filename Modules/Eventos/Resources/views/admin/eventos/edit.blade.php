...
@section('content')
    {!! Form::open(['route' => ['admin.eventos.eventos.update', $eventos->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('eventos::admin.eventos.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
