...
@section('content')
    {!! Form::open(['route' => ['admin.empresa.empresa.update', $empresa->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('empresa::admin.empresas.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
            ...
            $("#ciudad_id").chained("#pais_id");
             ...
             $("#subcategoria_id").change(function(){ /* WHEN YOU CHANGE AND SELECT FROM THE SELECT FIELD */
              ...
              $.ajax({ /* THEN THE AJAX CALL */
                ...
                url: "http://localhost:8000/es/api/tieneHijos", /* PAGE WHERE WE WILL PASS THE DATA */
                // url: 'http://URL DEL SERVIDOR/es/api/tieneHijos';
